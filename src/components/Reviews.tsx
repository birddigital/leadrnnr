        ...
        >
          <defs>
            ...
            >
              ...
              />
              <path
                d="M15 5h10v30H15zM35-5V5H5V-5zM35 35v10H5V35zM35-15h10v30H35zM55 15v10H25V15zM15
      15v10h-30V15zM35 25h10v30H35zM-5 25H5v30H-5zM-5-15H5v30H-5z"
                stroke-width="0.1"
      ...
      <div className="mx-auto max-w-screen-2xl p-6">
        ...
        <div className="mt-4 items-start justify-between md:flex-row flex flex-col gap-6">
          <div className="md:max-w-2xl">
            ...
            <p className="mt-4 text-gray-500">
              ...
              placeat illo enim quae? Praesentium nobis officiis reprehenderit.
            </p>
          </div>
          <a
            href="#"
        ...
        <div className="mt-8 lg:grid-cols-3 grid gap-8">
          <div className="w-full justify-around rounded-xl bg-white shadow-md flex flex-col border border-gray-300 p-8">
            ...
            C34.419,0.881,33.03,0,31.504,0c-1.527,0-2.915,0.881-3.565,2.265l-7.623,16.238L3.347,21.096c-1.458,0.223-2.669,1.242-3.138,2.642 c-0.469,1.4-0.115,2.942,0.916,4l12.392,12.707l-2.935,17.977c-0.242,1.488,0.389,2.984,1.62,3.854 c1.23,0.87,2.854,0.958,4.177,0.228l15.126-8.365l15.126,8.365c0.597,0.33,1.254,0.492,1.908,0.492c0.796,0,1.592-0.242,2.269-0.72 c1.231-0.869,1.861-2.365,1.619-3.854l-2.935-17.977l12.393-12.707C62.914,26.68,63.268,25.138,62.799,23.737z"
                />
              </svg>
              <svg
                className="h-8 w-8 p-2"
                version="1.0"
                id="Windframe_RmwwwaeZFF"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0
            0 64 64"
                enable-background="new 0 0 64 64"
            ...
            <p className="mt-8 text-gray-500">
              &apos;This app has been an absolute game-changer for me and my
              team, increasing our productivity. From scheduling client meetings
              to tracking sales targets, this app does it all. Its intuitive
              design allows me to stay organized without any hassle. I highly
              recommend this app&apos;
            </p>
